...
| **Qwen1.5-7B-chat** | 0.24                | 0.09               | 0.04             | 0.12              | 0.09         | 0.02          | 0.08              | 0.35              | 0.05           | 0.16           | 0.19           | 0.35           | **0.34**          | **0.25**                              |
| **Qwen2.5-7B-Instruct** | 0.46                | 0.29               | 0.02             | 0.13              | 0.15         | 0.09          | 0.10              | 0.39              | 0.19          | 0.23           | 0.26           | 0.09           | **0.33**          | **0.26**                              |
...
cd Agent-X
```
2. You can get the dataset from [release file](https://huggingface.co/datasets/Tajamul21/Agent-X/tree/main).
...
2. Deploy tools for Agent-X benchmark.
