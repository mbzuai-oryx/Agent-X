...
| **Model**         | Inst<sub>align</sub> | Tool<sub>acc</sub> | Arg<sub>acc</sub> | Sum<sub>acc</sub> | Faithfulness | Context-Score | Factual-Precision | Semantic-Accuracy | p<sub>f1</sub> | o<sub>f1</sub> | l<sub>f1</sub> | c<sub>f1</sub> | Ans<sub>acc</sub> | Ans<sub>acc</sub><sub>_w/img gen</sup> |
| ----------------- | -------------------- | ------------------ | ----------------- | ----------------- | ------------ | ------------- | ----------------- | ----------------- | -------------- | -------------- | -------------- | -------------- | ----------------- | ------------------------------------- |
